...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Costumer Master -->
            <li class="nav-item">
                <a class="nav-link @if(!request()->is('admin/costumer*')) collapsed @endif" href="#" data-toggle="collapse" data-target="#costumerMaster"
                    aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fas fa-fw fa-users"></i>
                    <span>Costumer</span>
                </a>
                <div id="costumerMaster" class="collapse @if(request()->is('admin/costumer*')) show @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{url('admin/costumer/create')}}">Add New</a>
                        <a class="collapse-item" href="{{url('admin/costumer')}}">View all</a>
                    </div>
                </div>
            </li>
